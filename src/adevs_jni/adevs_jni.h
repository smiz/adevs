...
struct JavaSimulator {
    ...
    jobject
        simulator_shared_jevent;  // This is the event to be used in Listener callbacks
 ...
 */
class JavaEventListenerManager : public EventListener<java_io> {
  public:
 ...
 */
class JavaAtomic : public Atomic<java_io>, public JavaDevs {
  public:
    JavaAtomic(jobject jmodel_loc_ref, JavaSimulator &owner);
    void delta_int();
    void delta_ext(double e, Bag<java_io> const &xb);
    void delta_conf(Bag<java_io> const &xb);
    double ta();
 ...
 */
class JavaNetwork : public Network<java_io>, public JavaDevs {
  public:
    JavaNetwork(jobject jmodel_loc_ref, JavaSimulator &owner);
    void getComponents(Set<Devs<java_io>*> &c);
    void route(java_io const &x, Devs<java_io>* model, Bag<Event<java_io>> &r);
    bool model_transition();
    ~JavaNetwork();
};

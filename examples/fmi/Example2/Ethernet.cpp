...
void Rx::delta_ext(double e, Bag<IO_Type> const &xb) {
...
void Rx::delta_conf(Bag<IO_Type> const &xb) {
    delta_int();
    delta_ext(0.0, xb);
}
...
void Tx::delta_ext(double e, Bag<IO_Type> const &xb) {
...
void Tx::delta_conf(Bag<IO_Type> const &xb) {
    delta_int();
    delta_ext(0.0, xb);
}

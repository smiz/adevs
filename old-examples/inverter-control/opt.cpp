...
/**
  ...
  */
class Listener : public EventListener<event_t> {
  public:
...
static double const C0 = 1E-3;
static double const Linv0 = 293E-6;
static double const G0 = 0.5;
static double const H0 = 0.1;
static int const num_samples = 30000;

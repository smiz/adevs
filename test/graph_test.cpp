...
using Graph = adevs::Graph<int, int>;

class TestAtomic : public Atomic {
  public:
    TestAtomic() : Atomic<int, int>() {}
    void delta_int() {}
    void delta_ext(int, std::list<PinValue> const &) {}
...
void test1() {
    std::list<std::pair<pin_t, std::shared_ptr<Atomic>>> models;
    std::shared_ptr<Atomic> a(new TestAtomic());
    std::shared_ptr<Atomic> b(new TestAtomic());
    Graph g;
    g.add_atomic(a);
    g.add_atomic(b);
...
void test7() {
    ...
    std::shared_ptr<Atomic> a(new TestAtomic());
    std::shared_ptr<Atomic> b(new TestAtomic());
    std::shared_ptr<Atomic> c(new TestAtomic());
    Graph g;
    pin_t pin0, pin1, pin2;
    g.add_atomic(a);
    g.add_atomic(b);
